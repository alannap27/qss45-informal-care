"""Shared for the QSS 45 caregiving project.
...
# Re-exported from figstyle so the two projects cannot change to different
# palettes. A color being changed there causes every figure in both repos to follow.
import figstyle
...
def build_features(df, extra=None, drop=None):
    ...
    That matters because the missingness is not at random: the word
    recall test is missing for the cognitively impaired and
    proxy-interviewed respondents.
    """
